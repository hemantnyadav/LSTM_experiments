...
class LSTM_NIG(keras.layers.Layer):
	...
	def __init__(self,
		...
		super(LSTM_NIG, self).__init__(**kwargs)
	...
	def _compute_carry_and_output(self, x, h_tm1, c_tm1):
		...
		#HNY NO Input gate So remomve i from second term NIG
		c = f * c_tm1 + self.activation(x_c + backend.dot(
