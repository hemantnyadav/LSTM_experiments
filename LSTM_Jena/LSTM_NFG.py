...
class LSTM_NFG(keras.layers.Layer):
	...
	def __init__(self,
		...
		super(LSTM_NFG, self).__init__(**kwargs)
	...
	def _compute_carry_and_output(self, x, h_tm1, c_tm1):
		...
		# HNY No forget Gate so removed f from first term
		c = c_tm1 + i * self.activation(x_c + backend.dot(
